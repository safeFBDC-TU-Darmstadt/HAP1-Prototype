...
title: "Platform-Prototype TruFinance / Basic Infrastructure"
layout: default
---

Three groups from the Technical University of Darmstadt are involved in the safeFBDC project: The [Data Management Lab](https://www.informatik.tu-darmstadt.de/datamanagement/datamanagement/index.en.jsp), the [Software Technology Group](https://www.stg.tu-darmstadt.de/main_stg/index.en.jsp) and the [AI & ML Lab](https://www.ml.informatik.tu-darmstadt.de/). Together, we are working towards solving important technological challenges for the project. On this site, we collect descriptions of our research, publications and links to corresponding code and artifacts.
...
The finished and published work of the Data Management Lab is centered around two main topics: [verifiable and secure data sharing](#verifiable-and-secure-data-sharing) and [secure and privacy-preserving federated ML](#secure-and-privacy-preserving-federated-machine-learning).

### Verifiable and Secure Data Sharing

When sharing data in high-stakes domains like finance, there is a clear need for accountability, security and correctness. Distributed Ledgers, also known as Blockchains, can help to achieve these properties. However, we can also try to support new properties like verifiability with existing database systems.
